...
1. No Supabase, rode as migrations de `supabase/migrations/` em ordem (SQL Editor) — as `20260925000000_planejamento_tributario.sql`, `20260926000000_ncm_destinatario.sql` `20260927000000_parceiros_icms.sql` e `20260928000000_regime_fornecedor.sql` criam as tabelas do planejamento tributário.
